 ...
 "cells": [
  {
   ...
   "id": "33a6f03f-7d94-436c-9115-412985d9c38a",
   "metadata": {},
   "outputs": [],
   "source": [
    "### Required Libraries ###\n",
    ...
    "    risk_levels = {\n",
    "        'none': '100% bonds (AGG), 0% stocks (SPY)',\n",
    "        'low': '60% bonds (AGG), 40% stocks (SPY)',\n",
    "        'medium': '40% bonds (AGG), 60% stocks (SPY)',\n",
    "        'high': '20% bonds (AGG), 80% stocks (SPY)'\n",
    "    }\n",
    "    \n",
    ...
    "        validation_result = validate_data(birthday, investment_amount, intent_request)\n",
    ...
    "            'content':'''{} thank you for your info. Based on the risk\n",
    "            level you defined, my recommendation is to choose a portfolio with {}\n",
    ...
    "            False,\n",
    "            \"age\",\n",
    "            \"Please provide a different age, this program is for ages 21-65\",\n",
    "            )\n",
    ...
    "                False,\n",
    "                \"investment_amount\",\n",
    "                \"The minimum investment amount required is $5000, please provide sufficient dollar amount to invest.\",\n",
    "                )\n",
